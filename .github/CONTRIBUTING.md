...
# Contributing to Nextcloud Calendar

Thank you for considering contributing to **Nextcloud Calendar!** 🎉 Contributions help make this project better for everyone.
...
2. **Clone the repository**
   ```bash
   git clone https://github.com/SoluceTechnologies/nextcloud-calendar-mobile
   ```
